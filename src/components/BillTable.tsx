    ...
    <div className="overflow-auto max-h-[calc(100vh-140px)] rounded-xl border border-white/10 shadow-2xl backdrop-blur-md bg-white/5 mx-[-16px] md:mx-0">
      <table className="w-full text-sm text-left text-neutral-300">
        <thead className="text-xs uppercase bg-[#1e293b] text-neutral-100 font-bold tracking-wider sticky top-0 z-20 shadow-md">
          <tr>
            <th className="px-2 py-3 sticky left-0 z-30 bg-[#1e293b] w-12 text-center border-r border-white/10 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.5)]">
              Mo
            </th>
            <th className="px-3 py-3 sticky left-12 z-30 bg-[#1e293b] min-w-[60px] border-r border-white/10 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.5)]">
              Date
            </th>
...
const Row = ({
  ...
  if (isPayday) {
    return (
      <tr
        id={`row-${entry.id}`}
        className="bg-emerald-500/10 border-y border-emerald-500/20 font-bold text-white relative group"
      >
