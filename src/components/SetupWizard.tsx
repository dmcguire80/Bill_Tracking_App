            ...
            <div className="w-full max-w-4xl">
                ...
                <div className="bg-[#1e293b] border border-white/10 rounded-2xl p-8 shadow-2xl min-h-[500px] flex flex-col">
                    <div className="flex-1">
                        {/* Steps content omitted for brevity - no changes needed inside steps */}
                        {currentStep === 0 && ( /* ... */ <div className="text-center space-y-6">
                    ...
                    <div className="flex justify-between mt-8 pt-6 border-t border-white/10">
                        ...
                        >
                            {isSubmitting ? 'Creating...' : currentStep === steps.length - 1 ? 'Start Tracking' : 'Next'}
