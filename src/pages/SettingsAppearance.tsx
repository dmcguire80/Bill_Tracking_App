            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <button
                        ...
                        className={`flex flex-col items-center gap-3 p-4 rounded-xl border transition-all ${theme === 'light'
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center gap-3 p-4 rounded-xl border transition-all ${theme === 'dark'
                                ? 'bg-emerald-500/10 border-emerald-500 text-emerald-400'
                                : 'bg-black/20 border-white/10 text-neutral-400 hover:border-white/20 hover:bg-white/5'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center gap-3 p-4 rounded-xl border transition-all ${theme === 'system'
                                ? 'bg-emerald-500/10 border-emerald-500 text-emerald-400'
                                : 'bg-black/20 border-white/10 text-neutral-400 hover:border-white/20 hover:bg-white/5'
                            }`}
                    >
