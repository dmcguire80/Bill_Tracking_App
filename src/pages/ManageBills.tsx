        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {templates
            ...
            .map(t => (
              <div
                key={t.id}
                className="bg-[#1e293b] border border-white/10 rounded-xl p-6 relative group"
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    ...
                    {t.endMonth && (
                      <div className="text-xs text-neutral-500 mt-1">Ends: {t.endMonth}</div>
                    )}
                  </div>
                  <button
              ...
              <form onSubmit={handleSave} className="space-y-4">
                ...
                <div className="flex gap-3 pt-4">
                  <button
                    ...
                    className="flex-1 py-2 bg-white/5 rounded-lg text-neutral-300"
                  >
                    Cancel
                  </button>
                  <button
