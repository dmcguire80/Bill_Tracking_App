...
export const DataManagement = () => {
    ...
    const handleDeleteAccount = async () => {
        const confirm1 = window.confirm('Are you sure you want to delete your account? This will permanently delete all your data and cannot be undone.');
        if (!confirm1) return;

        const confirm2 = window.confirm('LAST WARNING: This action is irreversible. Are you absolutely sure?');
        if (!confirm2) return;

        try {
            await deleteAccountData(); // Delete Firestore data
            await deleteAccount();     // Delete Auth user
        } catch (error) {
    ...
    return (
        <>
                        ...
                        <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-6 md:col-span-2">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-neutral-400">Irreversible account actions.</p>
                                </div>
                            </div>

                            <p className="text-neutral-400 mb-6 text-sm">
                                Deleting your account will permanently remove all your data, including bills, accounts, and history.
            ...
            <div className="text-center mt-12 mb-8">
                <span className="text-xs text-slate-500 font-mono">v0.9.10</span>
            </div>
        </>
    );
};
